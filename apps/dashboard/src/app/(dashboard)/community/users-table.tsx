          ...
          users.map((u, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center px-4 py-3.5">
                  <span
                    className={`text-xs font-semibold px-2 py-0.5 rounded-full border capitalize ${STATUS_STYLES[status] ?? STATUS_STYLES.active}`}
                  >
                    {status}
                  </span>
                </div>
                    ...
                    <>
                      {status !== "active" && (
                        <button
                          ...
                          className="flex items-center gap-1 px-2 py-1.5 rounded-lg text-xs font-medium text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 hover:bg-emerald-500/20 transition-colors"
                        >
                      ...
                      {status !== "suspended" && u.role !== "admin" && (
                        <button
                          ...
                          className="flex items-center gap-1 px-2 py-1.5 rounded-lg text-xs font-medium text-amber-400 bg-amber-500/10 border border-amber-500/20 hover:bg-amber-500/20 transition-colors"
                        >
                      ...
                      {status !== "banned" && u.role !== "admin" && (
                        <button
                          ...
                          className="flex items-center gap-1 px-2 py-1.5 rounded-lg text-xs font-medium text-red-400 bg-red-500/10 border border-red-500/20 hover:bg-red-500/20 transition-colors"
                        >
