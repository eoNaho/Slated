...
const mockLists = [
    {
        ...
        description: "A curated collection of the most mind-bending science fiction films",
        itemsCount: 25,
        likesCount: 1432,
        viewsCount: 12050,
        isPublic: true,
...
export default function ListsExample() {
    return (
        <div className="bg-zinc-950 min-h-screen p-8 space-y-16">
            ...
            <div>
                <h3 className="text-2xl font-bold text-white mb-4">Large 01 (Default)</h3>
                <UserLists lists={mockLists} variant="lg01" limit={3} />
            </div>

            {/* MEDIUM 01 - Lista média com título à direita */}
            <div>
                <h3 className="text-2xl font-bold text-white mb-4">Medium 01 (Title Right)</h3>
                <UserLists lists={mockLists} variant="md01" limit={3} />
            </div>

            {/* MEDIUM 02 - Lista média com título à direita (alternativa) */}
            <div>
                <h3 className="text-2xl font-bold text-white mb-4">Medium 02 (Title Right Alt)</h3>
                <UserLists lists={mockLists} variant="md02" limit={3} />
            </div>

            {/* EXTRA LARGE - Lista extra grande com mais slots */}
            <div>
                <h3 className="text-2xl font-bold text-white mb-4">Extra Large (8 slots)</h3>
            ...
            <div>
                ...
                <UserLists lists={mockLists} variant="card" gridLayout={true} limit={8} />
            </div>

            {/* LARGE 02 - Cards grandes */}
            <div>
                <h3 className="text-2xl font-bold text-white mb-4">Large 02 Grid</h3>
                <UserLists lists={mockLists} variant="lg02" gridLayout={true} limit={6} />
            </div>

            {/* THUMBNAIL EXTRA LARGE - Thumbnails extra grandes com overlay (NOVO) */}
            <div>
                <h3 className="text-2xl font-bold text-white mb-4">Thumbnail Extra Large (Overlay)</h3>
                <UserLists lists={mockLists} variant="thumbnail-xlg" gridLayout={true} limit={6} />
            </div>

            {/* THUMBNAIL LARGE - Thumbnails grandes com overlay */}
            <div>
                <h3 className="text-2xl font-bold text-white mb-4">Thumbnail Large (Overlay)</h3>
                <UserLists lists={mockLists} variant="thumbnail-lg" gridLayout={true} limit={6} />
            </div>

            {/* THUMBNAIL MEDIUM - Thumbnails médios com overlay */}
            <div>
                <h3 className="text-2xl font-bold text-white mb-4">Thumbnail Medium (Overlay)</h3>
                <UserLists lists={mockLists} variant="thumbnail-md" gridLayout={true} limit={8} />
            </div>

            {/* THUMBNAIL SMALL - Thumbnails pequenos com overlay */}
            <div>
                <h3 className="text-2xl font-bold text-white mb-4">Thumbnail Small (Overlay)</h3>
                <UserLists lists={mockLists} variant="thumbnail-sm" gridLayout={true} limit={10} />
            </div>

            {/* THUMBNAIL WIDE - Thumbnails largos horizontais com overlay (NOVO) */}
            <div>
                <h3 className="text-2xl font-bold text-white mb-4">Thumbnail Wide (Horizontal Overlay)</h3>
                <UserLists lists={mockLists} variant="thumbnail-wide" gridLayout={true} limit={4} />
            </div>
        </div>
    );
}